...
public class Main {
    ...
    public static void main(String[] args) {
        List<String> FulfillLogo = new ArrayList<String>();
        FulfillLogo.add("  ______     _  __ _ _ _    _____       _             _   ");
        FulfillLogo.add(" |  ____|   | |/ _(_) | |  / ____|     (_)           | |  ");
        FulfillLogo.add(" | |__ _   _| | |_ _| | | | (___  _ __  _  __ _  ___ | |_ ");
        FulfillLogo.add(" |  __| | | | |  _| | | |  \\___ \\| '_ \\| |/ _` |/ _ \\| __|");
        FulfillLogo.add(" | |  | |_| | | | | | | |  ____) | |_) | | (_| | (_) | |_ ");
        FulfillLogo.add(" |_|   \\__,_|_|_| |_|_|_| |_____/| .__/|_|\\__, |\\___/ \\__|");
        FulfillLogo.add("                                 | |       __/ |          ");
        FulfillLogo.add("                                 |_|      |___/           ");
        FulfillLogo.forEach(System.out::println);
        ...
        OptionParser parser = new OptionParser() {
            {
                ...
                // FulfillSpigot start
                acceptsAll(asList("fulfillspigot-settings"), "File for FulfillSpigot settings")
                    .withRequiredArg()
                    .ofType(File.class)
                    .defaultsTo(new File("fulfillspigot.yml"))
                    .describedAs("Yml file");

                acceptsAll(asList("database-settings"), "File for FulfillSpigot database settings")
                    .withRequiredArg()
                    .ofType(File.class)
                    .defaultsTo(new File("database.yml"))
                    .describedAs("Yml file");

                acceptsAll(asList("knockback", "knockback-settings"), "File for FulfillSpigot knockback settings")
