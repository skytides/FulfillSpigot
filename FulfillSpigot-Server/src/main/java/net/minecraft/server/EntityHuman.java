...
public abstract class EntityHuman extends EntityLiving {
    ...
    public void m() {
        ...
        float f1 = (float) ( TrigMath.atan(-this.motY * 0.20000000298023224D) * 15.0D); // CraftBukkit
    ...
    public void b(Entity entity, int i) {
        ...
        Collection<ScoreboardScore> collection = this.world.getServer().getScoreboardManager().getScoreboardScores(IScoreboardCriteria.f, this.getName(), new ArrayList<ScoreboardScore>());
    ...
    public void setAbsorptionHearts(float f) {
        ...
        // FulfillSpigot Start - Player Health Change Event
        if (previous != f) {
