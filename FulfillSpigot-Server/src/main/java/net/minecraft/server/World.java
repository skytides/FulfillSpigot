...
public abstract class World implements IBlockAccess {
    ...
    public FulfillSpigotWorldConfig pandaSpigotConfig; // PandaSpigot
    ...
    private List<Entity> dimensionChangeQueue = java.util.Collections.synchronizedList(new ArrayList<>());
    ...
    protected World(IDataManager idatamanager, WorldData worlddata, WorldProvider worldprovider, MethodProfiler methodprofiler, boolean flag, ChunkGenerator gen, org.bukkit.World.Environment env) {
        ...
        this.pandaSpigotConfig = FulfillSpigotConfig.getWorldConfig(worlddata.getName()); // PandaSpigot
        this.generator = gen;
    ...
    public boolean addEntity(Entity entity, SpawnReason spawnReason) { // Changed signature, added SpawnReason
        ...
        if (!flag && !this.isChunkLoaded(i, j, true)) {
            ...
            if (entity instanceof EntityLiving) {
                ((EntityLiving) entity).maxNoDamageTicks = FulfillSpigotConfig.get().hitDelay;
            }



            if (entity instanceof EntityPotion) {
                entity.motY -= FulfillSpigotConfig.get().potionSpeed;

                if (!(FulfillSpigotConfig.get().potionSpeed == 0)) {
    ...
    public void removeEntity(Entity entity) {
        ...
        if (entity instanceof EntityHuman) {
            this.players.remove(entity);
            this.worldMaps.removeTrackedPlayer((EntityHuman) entity); // FulfillSpigot - Fix memory leak
            this.everyoneSleeping();
        }
    ...
    // FulfillSpigot start - Ignore entities
