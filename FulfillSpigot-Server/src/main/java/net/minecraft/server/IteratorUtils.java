...
public class IteratorUtils {
    ...
    static class ClassIterable<T> implements Iterable<T[]> {
        ...
        public Iterator<T[]> iterator() {
            return (Iterator) (this.b.length <= 0 ? Collections.singletonList((Object[]) IteratorUtils.b(this.a, 0)).iterator() : new IteratorUtils.ClassIterable.ClassIterator(this.a, this.b, (IteratorUtils.SyntheticClass_1) null));
        }
        ...
        static class ClassIterator<T> extends UnmodifiableIterator<T[]> {
            ...
            ClassIterator(Class oclass, Iterable[] aiterable, IteratorUtils.SyntheticClass_1 iteratorutils_syntheticclass_1) {
                this(oclass, aiterable);
            }
        }
    }
