...
public abstract class Entity implements ICommandListener {
    ...
    public static final Random SHARED_RANDOM = new FastRandom() {
    ...
    public void move(double d0, double d1, double d2) {
        ...
        if (this.noclip) {
            ...
            Iterator iterator1;
            // FulfillSpigot start - getCubesNoEntities
            if(this.world.paperSpigotConfig.fixEastWest && Math.abs(d0) > Math.abs(d2)) { //TacoSpigot - fix east/west cannoning by calculating the z movement before x if the x velocity is greater
                if(axisScan) list = this.world.getCubesNoEntities(this, this.getBoundingBox().a(0, 0, d2)); // TacoSpigot - get z axis blocks
                ...
                if(axisScan) list = this.world.getCubesNoEntities(this, this.getBoundingBox().a(d0, 0, 0)); // TacoSpigot - get x axis blocks
    ...
    public void c(int i) {
        // FulfillSpigot start - Entities will be queued and teleported after all worlds have been ticked
        if(i != this.dimension) {
    ...
    public void teleportTo(Location exit, boolean portal) {
        if (true) {
            ...
            if (entity != null) {
                ...
                entity.bukkitEntity = (CraftEntity) this.getBukkitEntity();
