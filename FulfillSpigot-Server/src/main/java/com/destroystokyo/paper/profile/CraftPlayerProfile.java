...
import com.destroystokyo.paper.paper.profile.ProfileProperty;
...
public class CraftPlayerProfile implements PlayerProfile {
    ...
    public boolean completeFromCache() {
        ...
        return completeFromCache(false, FulfillSpigotConfig.get().isProxyOnlineMode());
    }
    ...
    public boolean complete(boolean textures) {
        MinecraftServer server = MinecraftServer.getServer();
        return complete(textures, FulfillSpigotConfig.get().isProxyOnlineMode());
    }
